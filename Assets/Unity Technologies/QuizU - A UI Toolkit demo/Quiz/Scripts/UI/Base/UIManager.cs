...
namespace Quiz
{
    ...
    public class UIManager : MonoBehaviour
    {
        ...
        // Tabbed Shop Screen
        UIScreen m_ShopScreen;

        // Tabbed leaderboard Screen
        UIScreen m_LeaderboardScreen;

        // Tabbed Profile screen
        UIScreen m_ProfileScreen;
        ...
        private void SubscribeToEvents()
        {
            ...
            UIEvents.LeaderboardShown += UIEvents_LeaderboardShown;
            UIEvents.ProfileShown += UIEvents_ProfileShown;
        ...
        private void UIEvents_ShopShown()
        {
            Show(m_ShopScreen);
        }

        private void UIEvents_LeaderboardShown()
        {
        ...
        private void Initialize()
        {
            ...
            m_ShopScreen = new ShopScreen(root.Q<VisualElement>("shop__container"));
            m_LeaderboardScreen = new LeaderboardScreen(root.Q<VisualElement>("leaderboard__container"));
            m_ProfileScreen = new ProfileScreen(root.Q<VisualElement>("profile__container"));
