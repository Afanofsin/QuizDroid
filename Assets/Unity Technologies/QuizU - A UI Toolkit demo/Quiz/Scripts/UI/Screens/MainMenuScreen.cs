...
namespace Quiz
{
    ...
    public class MainMenuScreen : UIScreen
    {
        ...
        Button m_ShopButton;       // Button to load the Shop scene
        ...
        private void SetVisualElements()
        {
            ...
            m_ShopButton = m_RootElement.Q<Button>("menu__button-shop");

            m_LeaderboardButton = m_RootElement.Q<Button>("menu__button-leaderboard");
            m_ProfileButton = m_RootElement.Q<Button>("menu__button-profile");
        ...
        private void RegisterCallbacks()
        {
            ...
            m_EventRegistry.RegisterCallback<ClickEvent>(m_ShopButton, evt => UIEvents.ShopShown?.Invoke());
            m_EventRegistry.RegisterCallback<ClickEvent>(m_LeaderboardButton, evt => UIEvents.LeaderboardShown?.Invoke());
            m_EventRegistry.RegisterCallback<ClickEvent>(m_ProfileButton, evt => UIEvents.ProfileShown?.Invoke());
