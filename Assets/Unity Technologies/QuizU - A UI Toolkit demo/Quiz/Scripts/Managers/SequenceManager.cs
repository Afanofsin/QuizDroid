...
namespace Quiz
{
    ...
    public class SequenceManager : MonoBehaviour
    {
        ...
        IState m_MenuShopState;         // Show the Shop Screen while in the Main Menu
        IState m_MenuLeaderboardState;  // Show leaderboard screen
        IState m_MenuProfileState;      // Show profile screen
        ...
        private void SetStates()
        {
            ...
            m_MenuShopState = new State(null, "ShopState", m_Debug);
            m_MenuLeaderboardState = new State(null, "LeaderboardState", m_Debug);
            m_MenuProfileState = new State(null, "ProfileState", m_Debug);
        ...
        private void AddLinks()
        {
            ...
            ActionWrapper shopShownWrapper = new ActionWrapper
            {
                Subscribe = handler => UIEvents.ShopShown += handler,
                Unsubscribe = handler => UIEvents.ShopShown -= handler
            };

            ActionWrapper leaderboardShownWrapper = new ActionWrapper
            {
                Subscribe = handler => UIEvents.LeaderboardShown += handler,
                Unsubscribe = handler => UIEvents.LeaderboardShown -= handler
            };

            ActionWrapper profileShownWrapper = new ActionWrapper
            {
                Subscribe = handler => UIEvents.ProfileShown += handler,
                Unsubscribe = handler => UIEvents.ProfileShown -= handler
            };
